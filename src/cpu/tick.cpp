...
uint CPU::executeInstruction() {

  // reset the branched flag from last instruction,
  //  it will be set to true if the instruction was a branch instruction and was
  //  taken.
  jumped = false;
  u8 opcode = mem[pc];
...
void CPU::implementOpcode(u8 opcode) {
  ...
  case 0x33:
    ...
    break;
  case 0x34:
    mem[HL] = inc8bit_mHL(mem[HL]);
    break;
  case 0x35:
    mem[HL] = dec8bit_mHL(mem[HL]);
    break;
  case 0x36:
    ld_mr16_n8(HL);
    break;
