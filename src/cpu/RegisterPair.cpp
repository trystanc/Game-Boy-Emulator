...
u16 operator+(RegisterPair rp, u16 num) { return static_cast<u16>(rp) + num; }

u16 operator+(RegisterPair rp1, RegisterPair rp2) {
  return static_cast<u16>(rp1) + static_cast<u16>(rp2);
}

u16 operator+(u16 num, RegisterPair rp) { return static_cast<u16>(rp) + num; }
...
u16 operator-(u16 num, RegisterPair rp) { return num - static_cast<u16>(rp); }
